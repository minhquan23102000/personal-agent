...
from src.memory.memory_toolkit.static_flow.context_memory_update import (
    ContextMemoryUpdate,
...
async def reflection_conversation(
    ...
    try:
        ...
        memory_updates = await context_memory_update(
            summary=summary_str,
        ...
        await memory_manager.store_context_memory(
            conversation_id=memory_manager.agent.conversation_id,
